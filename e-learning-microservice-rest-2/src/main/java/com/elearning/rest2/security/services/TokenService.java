package com.elearning.rest2.security.services;
...
/**
 * Service class responsible for validating if the token coming from request is valid. It will check against ehCache.
 * @author Gustavo Orsi
 *
 */
